<template>
  ...
  <el-alert
    ...
    show-icon>
		...
		<el-input placeholder="请输入权限名" v-model="query.rightName" class="input-with-select">
    <el-button slot="append" icon="el-icon-search" @click="search"></el-button>
  </el-input>
  <Right :rights="rights" :module="module" :currentRow="currentRow" :tableData="tableData" :moduleId="5" v-on:initRight="initRight" v-on:deleteRow="deleteRow"></Right>
      ...
      <template slot-scope="props">
        <el-form label-position="left" inline class="demo-table-expand">
          ...
          <el-form-item label="权限描述">
            <span>{{ props.row.rightTxt }}</span>
          </el-form-item>
          <el-form-item label="模块编号">
            <span>{{ props.row.moduleId }}</span>
          </el-form-item>
    ...
    <el-table-column
      label="权限名"
      prop="rightName" sortable="custom">
    </el-table-column>
  </el-table>
    <el-pagination

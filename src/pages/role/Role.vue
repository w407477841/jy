<template>
  ...
  <Right :rights="rights" :module="module" :currentRow="currentRow" :tableData="tableData" :moduleId="4" v-on:initRight="initRight" v-on:deleteRow="deleteRow"></Right>
		 <el-table
    :data="tableData"
